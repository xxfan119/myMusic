<template>
   <div class="songlists">
    ...
    <van-tabs class="info" background='#f5f5f5' sticky   animated :swipeable='true' color='rgb(22, 211, 32)' title-active-color='rgb(22, 211, 32)'>
    <van-tab v-for="(tab,index) of titles" :key="tab.id" :title='tab.name' :name='tab.id'>
        <ul class="songList">
