<template>
  <div class="mvinfo">
    ...
    <div class="mvi">
      <div class="head">
        <div>
          <img :src="info.info.singers[0].picurl" /><span>{{
            info.info.singers[0].name
          }}</span>
        </div>
      ...
      <div class="relatedMV">
        <div>
          ...
          <span
            ...
            {{ info.info.singers[0].name }}</span
          >
        </div>
        <div>
          <ul>
            <li
              v-for="(item, index) of info.recommend"
              :key="item.sid"
              @click="toMv(index)"
            >
              ...
              <div>
                <span>{{ item.name }}</span>
                <span>来自 {{ item.uploader_nick }}</span>
              </div>
            </li>
          </ul>
        </div>
